  ...
  return (
    <div className="bg-[#212529]">
      ...
      <div className="max-w-screen-xl mx-auto p-4">
        {/* Layout */}
        <div className="flex flex-col md:flex-row md:py-[20px] md:gap-[100px]">
          {/* Footer brand */}
          <div className="flex flex-col text-white mb-4">
            <img src={Logo} alt="" className="mt-4 w-[300px]" />
            <p className="text-base leading-[28px] mt-4 ">
          ...
          <div className="w-full grid md:grid-cols-2 gap-4 lg:grid-cols-3">
            ...
            <div className="text-white mb-4">
              <h3 className="font-medium text-xl ">Menu</h3>
              <ul className="flex flex-col items-start gap-2 pt-2 text-base">
